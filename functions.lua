...
function functions.getYoutube(vid)
    ...
    client:setGame("Tocando " .. playing)
...
function functions.isYoutube(str)
    if
        functions.startsWith(str, "https://www.youtube.com/watch?v=") or
            functions.startsWith(str, "http://www.youtube.com/watch?v=") or
            functions.startsWith(str, "www.youtube.com/watch?v=") or
            functions.startsWith(str, "youtube.com/watch?v=") or
            functions.startsWith(str, "https://youtu.be/") or
            functions.startsWith(str, "http://youtu.be/") or
            functions.startsWith(str, "youtu.be/")
     then
        return true
    else
        return false
